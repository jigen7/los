...
class Form_PopupBox extends Zend_Form
{
	...
	$dev_veh_use_taxi_downpayment = new Zend_Form_Element_Text('dev_veh_use_taxi_downpayment');
	$dev_veh_use_taxi_downpayment->removeDecorator('label')
				->removeDecorator('HtmlTag')
				->addFilter('StringTrim')
				->addFilter('StripTags')
				->addFilter('StringToUpper')
				->setAttrib('size','60');
	$this->addElement($dev_veh_use_taxi_downpayment);
	
	$dev_veh_use_taxi_term = new Zend_Form_Element_Text('dev_veh_use_taxi_term');
	$dev_veh_use_taxi_term->removeDecorator('label')
				->removeDecorator('HtmlTag')
				->addFilter('StringTrim')
				->addFilter('StripTags')
				->addFilter('StringToUpper')
				->setAttrib('size','60');
	$this->addElement($dev_veh_use_taxi_term);
