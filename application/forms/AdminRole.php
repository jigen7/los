<?
class Form_AdminRole extends Zend_Dojo_Form
{
	...
	$addrole = new Zend_Form_Element_Text('addrole');
	$addrole->removeDecorator('label')
				->removeDecorator('HtmlTag')
				 ->addFilter('StringTrim')
				 ->addFilter('StripTags')
				 ->addFilter('StringToUpper')
				 ->setAttrib('size','25');
	$this->addElement($addrole);
	
	$modifyrole = new Zend_Form_Element_Text('modifyrole');
	$modifyrole->removeDecorator('label')
				->removeDecorator('HtmlTag')
				 ->addFilter('StringTrim')
				 ->addFilter('StripTags')
				 ->addFilter('StringToUpper')
				 ->setAttrib('size','25');
	$this->addElement($modifyrole);
