...
class Model_Admin_TurnAroundHoliday extends Zend_Db_Table_Abstract{
	...
	*   @desc revision on dateTimeDiff
	*   @spec 1day = 8hrs, lunch break, holidays, saturday and sunday not included on counting
	*   @param $end, end time
	*   @param $start, start time
	*   @return string type, the gap between start to end time
	*   @example start['2011-01-01 06:30:00'] - end['2011-01-01 19:30:00'] = 1d 
	*/
