<?php 
class Zend_Controller_Action_Helper_RecallModule extends Zend_Controller_Action_Helper_Abstract {
    function direct($capno) {
        /**
         * Paolo Marco M. Manarang
         * Sept 21,2010
         * Helper for MA Recall Procedure
